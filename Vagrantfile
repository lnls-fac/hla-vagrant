...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  config.vm.define :master do |master_config|
    ...
    master_config.vm.network "private_network", ip: "192.168.53.10"
  ...
  config.vm.define :va do |va_config|
    ...
    va_config.vm.network "private_network", ip: "192.168.53.11"
  ...
  config.vm.define :hla do |hla_config|
    ...
    hla_config.vm.network "private_network", ip: "192.168.53.12"
